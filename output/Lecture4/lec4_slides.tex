...
\newcommand{\thumbside}{%
  \begin{tikzpicture}[baseline=-0.3em]
    ...
    \node[white, font=\Large\bfseries] at (0.7,0.7) {?};
  \end{tikzpicture}%
}
...
\begin{frame}{Claim 1}
  ...
  \begin{tabular}{c@{\hspace{2em}}c@{\hspace{2em}}c}
    \thumbup & \thumbdown & \thumbside \\[0.5em]
    \textcolor{green}{\textbf{Agree}} & \textcolor{vermillion}{\textbf{Disagree}} & \textcolor{DarkGray}{\textbf{Not sure}}
  \end{tabular}
  ...
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item Sometimes, it's just not possible 
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \includegraphics[width=\textwidth]{fig/coffee_plantation.jpg}

      \vspace{0.3em}
      {\small\textcolor{DarkGray}{\textit{Coffee plantation in Colombia}}}
    \end{column}
  \end{columns}
...
\begin{frame}{Why Do Countries Trade?}
  ...
  \begin{columns}[T]
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \includegraphics[width=\textwidth]{fig/meta_hq.jpg}

      \vspace{0.3em}
      {\small\textcolor{DarkGray}{\textit{Meta headquarters in California}}}
    \end{column}
  \end{columns}
...
\begin{frame}{The Key: Opportunity Cost}
  ...
  \begin{tabular}{@{} l c c c c @{}}
    \toprule
    & \textbf{Software} & \textbf{Coffee} & \textbf{OC of Coffee} & \textbf{Benefit/OC of Coffee} \\
...
\begin{frame}{The Key: Opportunity Cost}
  ...
  \begin{tabular}{@{} l c c c c @{}}
    ...
    & (units) & (tons) & (software units) & (units/ton) \\
    \midrule
    \textcolor{blue}{\textbf{U.S.}} & 40 & 20 & 40 & $1/2$ \\
...
\begin{frame}{Deindustrialization in America}
  ...
  \begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      yticklabel style={font=\small, color=blue},
    ]
