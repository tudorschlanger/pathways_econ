...
\begin{frame}{Today's Agenda}
  ...
  \vspace{0.5em}
  \begin{enumerate}
    \item \textbf{Correlation vs.\ causation}: how to tell the difference
    \item \textbf{Misleading graphs}: how data can make you think it's causation!
...
\begin{frame}{A Suspicious Pattern}
  ...
  \centering
  \includegraphics[width=0.85\textwidth, height=6.5cm, keepaspectratio]{fig/margarine_divorce_maine.pdf}

  \vspace{0.3em}
  {\tiny\textcolor{lightgray}{Source: tylervigen.com --- Spurious Correlations. Correlation: $r = 0.99$ (where 1.0 would be a perfect match).}}
...
\begin{frame}{What's Going On?}
  ...
  \begin{questionbox}
    Does margarine \textbf{cause} divorce?\\[0.3em]
    In your group, come up with:
    \begin{enumerate}
      \item One \textbf{funny} explanation (technically possible but absurd)
      \item One sentence explaining why the chart \textbf{does not prove} causation
    \end{enumerate}
  \end{questionbox}
...
\begin{frame}{What's Going On?}
  ...
  \begin{answerbox}
    ...
    Both margarine use and divorce rates were declining over the same period---likely for completely unrelated reasons (changing diets, changing social norms).
  \end{answerbox}
...
\begin{frame}{Correlation}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \vspace{0.3em}
      \centering
      {\scriptsize\textbf{France, August 2003}}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          ylabel style={font=\tiny, color=orange!80!black},
          ...
          yticklabel style={font=\tiny, color=orange!80!black},
        ...
        \begin{axis}[
          ...
          axis y line*=right,
          axis x line=none,
          ylabel style={font=\tiny, color=blue!70!black},
          ylabel={Excess deaths/day},
          xmin=0.5, xmax=20.5,
          ymin=0, ymax=2500,
          ytick={0,500,1000,1500,2000},
          yticklabel style={font=\tiny, color=blue!70!black},
      ...
      \vspace{0.1em}
      {\tiny\textcolor{lightgray}{Illustrative data}}
    \end{column}
  \end{columns}

\end{frame}

\begin{frame}{Why Do Correlations Happen? (1/4)}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \vspace{0.8em}
      \begin{enumerate}
        \item \textcolor{vermillion}{\textbf{Coincidence}}---the pattern is random chance.\\
              {\small Margarine and divorce just happened to trend the same way.}
      \end{enumerate}
    \end{column}
    \begin{column}{0.48\textwidth}
      \vspace{0.5em}
      \includegraphics[width=\textwidth]{fig/margarine_divorce_maine.pdf}
...
\begin{frame}{Why Do Correlations Happen? (2/4)}
  ...
  \begin{enumerate}
    ...
    \vspace{0.6em}
    \item \textcolor{green}{\textbf{Causality}}---one thing truly causes the other.
  \end{enumerate}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Texting while driving $\rightarrow$ more accidents
      \end{itemize}
...
\begin{frame}{DAGs: A Thinking Tool}
  ...
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      ...
      \begin{itemize}
        \item \textbf{Direction}---which way does causation flow?
...
\begin{frame}{Why Do Correlations Happen? (3/4)}
  ...
  \begin{enumerate}
    ...
    \vspace{0.6em}
    \item \textcolor{green}{\textbf{Causality}}---one thing truly causes the other.\\
          {\small Flipping a switch turns the light on.}

    \vspace{0.6em}
    \item \textcolor{blue}{\textbf{Reverse causality}}---you got the direction backwards.
  \end{enumerate}
...
\begin{frame}{DAGs: Reverse Causality --- Example}
  ...
  \begin{tikzpicture}[
    ...
    \node[box] (a) {\textbf{\# ambulances}\\[0.2em]\textbf{at an accident}};
    \node[box, right=4cm of a] (b) {\textbf{\# of deaths}\\[0.2em]\textbf{at an accident}};
  \end{tikzpicture}
...
\begin{frame}{DAGs: Reverse Causality --- Example}
  ...
  \vspace{1.5em}
  \begin{insightbox}
    More ambulances at an accident, more deaths. Do ambulances \textbf{cause} deaths? No---worse accidents cause \textbf{both} more deaths and more ambulances to be called.
  \end{insightbox}

\end{frame}

\begin{frame}{Why Do Correlations Happen? (4/4)}
  ...
  \begin{enumerate}
    ...
    \vspace{0.6em}
    \item \textcolor{orange}{\textbf{Hidden third factor (confounder)}}---something else drives both.
  \end{enumerate}
...
\begin{frame}{DAGs: The Template}
  ...
  \begin{tikzpicture}[
    ...
    \draw[dashed, gray, thick] (a) -- node[below, font=\small, text=gray] {correlation (not causation!)} (b);
  \end{tikzpicture}
...
\begin{frame}{Which Story Is Right?}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \vspace{0.3em}
      {\small Does ice cream \textbf{cause} heatstroke?}
    \end{column}
    \begin{column}{0.48\textwidth}
      \pause
      \centering
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          axis y line*=left,
          xlabel style={font=\tiny},
          ylabel style={font=\tiny, color=vermillion},
          ylabel={Max temp.\ (\textdegree C)},
          xmin=0.5, xmax=20.5,
          ymin=25, ymax=44,
          xtick={1,5,10,15,20},
          xticklabels={Aug 1,5,10,15,20},
        ...
        \addplot[vermillion, thick, mark=none] coordinates {
          (1,33) (2,34) (3,35) (4,37) (5,38)
          (6,39) (7,40) (8,40) (9,40) (10,41)
          (11,40) (12,39) (13,36) (14,33)
          (15,30) (16,28) (17,27) (18,27) (19,28) (20,28)
        };
        \end{axis}
        \begin{axis}[
          width=\textwidth,
...
\begin{frame}{DAGs: An Example}
  ...
  \begin{tikzpicture}[
    ...
    \draw[dashed, gray, thick] (ice) -- node[below, font=\small, text=gray] {correlation (not causation!)} (heat);
  \end{tikzpicture}
...
\begin{frame}{From Patterns to Pictures}
  ...
  \vspace{2em}
  \emph{In Part 2, we will learn how graphs can trick you \textbf{without faking any data}.}
...
\begin{frame}{U.S.\ Steel Production}
  ...
  \centering
  {\large\bfseries Total U.S.\ Steel Production (Mt) 2024 v.\ 2025}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      xmin=-0.6, xmax=1.6,
      xtick={0,1},
      xticklabels={{\small 2024 Total Steel}\\\small{Production (Mt)}, {\small Total Steel Production}\\\small{2025 (Mt)}},
      xticklabel style={font=\small, align=center, text width=3.5cm},
...
\begin{frame}{What Do the Numbers Say?}
...
\begin{frame}{Chart Detective Toolkit}

  \begin{methodbox}
    \textbf{5 questions that save you from bad graphs:}
...
\begin{frame}{Your Turn: Be a Chart Detective}
  ...
  \vspace{0.8em}
  \Large\textcolor{blue}{You have about 2 minutes per chart.}

\end{frame}

% --- Case Study 1: Florida Gun Deaths ---

\begin{frame}{Case 1: Florida Gun Deaths}
    ...
    \begin{column}{0.55\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          y dir=reverse,
          xlabel={},
          ylabel={\small Number of murders (firearms)},
          xmin=1989, xmax=2015,
          ymin=0, ymax=1050,
          ytick={0,200,400,600,800,1000},
          yticklabel style={font=\tiny},
          xtick={1990,1995,2000,2005,2010,2014},
        ...
        \addplot[vermillion!80, fill=vermillion!30, thick] coordinates {
          (1990,873) (1991,891) (1992,900) (1993,898) (1994,881)
          (1995,834) (1996,785) (1997,740) (1998,699) (1999,675)
          (2000,693) (2001,688) (2002,699) (2003,715) (2004,743)
          (2005,721) (2006,740) (2007,752) (2008,770) (2009,800)
          (2010,828) (2011,870) (2012,893) (2013,897) (2014,873)
        } \closedcycle;

        % Stand Your Ground annotation
        \draw[black, thick, dashed] (2005,0) -- (2005,1050);
        \node[font=\tiny, text width=2.5cm, align=center, anchor=south] at (2005,10)
          {2005: ``Stand Your\\Ground'' law enacted};
        \end{axis}
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.55\textwidth}
      ...
      \begin{tikzpicture}
        ...
        % Label: FOX NEWS style
        \node[font=\tiny\bfseries, fill=blue!80, text=white, inner sep=2pt, rounded corners=1pt]
          at (0.8,5.2) {NEWS};
      \end{tikzpicture}
    \end{column}
  \end{columns}
    ...
    \begin{column}{0.55\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          bar width=5pt,
          xlabel={Year},
          ylabel={\small Temp.\ anomaly (\textdegree C)},
          title style={font=\small\bfseries},
        ...
        \addplot[fill=vermillion!60, draw=vermillion] coordinates {
          (2015,0.90) (2016,1.01) (2017,0.92) (2018,0.83)
          (2019,0.98) (2020,1.02) (2021,0.84) (2022,0.86)
        };
...
\begin{frame}{Case 3: The Bigger Picture}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      bar width=1pt,
      xlabel={Year},
      ylabel={\small Temperature anomaly (\textdegree C)},
      title style={font=\small\bfseries},
    ...
    % Approximate NOAA data: negative anomalies (blue) and positive (red)
    % Simplified representative data points
    \addplot[fill=blue!60, draw=blue!60] coordinates {
      (1880,-0.17) (1882,-0.10) (1884,-0.28) (1886,-0.31) (1888,-0.17)
      (1890,-0.35) (1892,-0.31) (1894,-0.32) (1896,-0.10) (1898,-0.27)
      (1900,-0.08) (1902,-0.27) (1904,-0.44) (1906,-0.22) (1908,-0.43)
      (1910,-0.43) (1912,-0.34) (1914,-0.15) (1916,-0.33) (1918,-0.26)
      (1920,-0.25) (1922,-0.26) (1924,-0.25) (1926,-0.06) (1928,-0.18)
      (1930,-0.09) (1932,-0.12) (1934,-0.11) (1936,-0.12) (1938,-0.02)
      (1940,0.10) (1942,0.09) (1944,0.20) (1946,-0.01) (1948,-0.04)
      (1950,-0.16) (1952,0.02) (1954,-0.12) (1956,-0.14) (1958,0.07)
      (1960,0.01) (1962,0.06) (1964,-0.20) (1966,-0.02) (1968,-0.07)
      (1970,0.04) (1972,0.02) (1974,-0.07) (1976,-0.10) (1978,0.07)
    };
    \addplot[fill=vermillion!60, draw=vermillion!60] coordinates {
      (1980,0.26) (1982,0.12) (1984,0.15) (1986,0.18) (1988,0.38)
      (1990,0.44) (1992,0.23) (1994,0.31) (1996,0.33) (1998,0.63)
      (2000,0.40) (2002,0.56) (2004,0.54) (2006,0.61) (2008,0.54)
      (2010,0.72) (2012,0.62) (2014,0.74) (2016,1.01) (2018,0.83)
      (2020,1.02) (2022,0.86)
    };
    \end{axis}
...
\begin{frame}{Same Data, Different Stories}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \vspace{0.3em}
      {\small\textbf{Context:} Inflation Reduction Act signed \textbf{Aug 16, 2022}.}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{methodbox}
        \textbf{Activity} (see handout):\\[0.3em]
        In pairs, create \textbf{two graphs} from the same data:
        \begin{itemize}
      ...
      \vspace{0.3em}
      \Large\textcolor{blue}{You have 8--10 minutes.}
    \end{column}
  \end{columns}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{tikzpicture}
        \begin{axis}[
          ...
          ymajorgrids=true,
          grid style={gray!15},
          title style={font=\tiny\bfseries, text=vermillion},
        ]
...
\begin{frame}{Take-Aways}
  ...
  \vspace{0.5em}
  \begin{itemize}
    \item \textbf{Correlation is not causation.} It can be:
      \begin{enumerate}
        \item Coincidence
