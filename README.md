...
This five-day workshop introduces high school students to economic thinking through real-world examples, interactive games, and policy debates. No prior economics knowledge is required.
...
```
output/
  Lecture1/          # Slides, worksheets, and figures for Day 1
  Lecture2/          # ...
  Lecture3/
  Lecture4/
  Lecture5/
codes/               # LaTeX preambles and templates
```
